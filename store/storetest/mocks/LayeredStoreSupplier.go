...
func (_m *LayeredStoreSupplier) GetGroupsByTeam(ctx context.Context, teamId string, page, perPage *int, hints ...store.LayeredStoreHint) *store.LayeredStoreSupplierResult {
	_va := make([]interface{}, len(hints))
	for _i := range hints {
		_va[_i] = hints[_i]
	}
